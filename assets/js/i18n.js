  ...
  resources: {
    en: {
      translation: {
        ...
        DATED_WARNING:
          'The property information shown may be out of date.<br/>Last update: September 2020.',
        ...
        NO_SEARCH_RESULTS_MESSAGE:
          "Sorry, we couldn't find that address. If your building is large, it may have multiple addresses. Try locating it on the map.",
        SEARCH_HINT:
          "These are the first {{ searchResultsLimit }} results. Don't see your building? Try typing more of your address.",

        ERROR_DB: 'Database error',
        ERROR_MESSAGE:
          "Sorry, we couldn't look up that property's details. Try again in an hour, or <a href='mailto:{{ supportEmail }}'>contact us</a>.",

        // PDF
        PDF_DOWNLOAD_ALL: 'Download all data for {{affiliatedWith}}',
        PDF_DOWNLOAD_PROPERTIES:
          'Download data for {{ owned }} taxpayer properties',
        PDF_DOWNLOAD_PROPERTY:
          'Download data for {{ owned }} taxpayer property',
    ...
    fr: {
      translation: {
        ...
        DATED_WARNING:
          'Les infos afficheés ne sont pas à jour.<br/>Dernière mise à jour: septembre 2020.',

        BROWSER_WARNING:
          "Internet Explorer n'est pas supporté. Essayez Chrome!",
        ...
        NO_SEARCH_RESULTS_MESSAGE:
          "Désolé, nous n'avons pas trouvé cette adresse. Pour les grands immeubles, il peut avoir plusieurs adresses. Essayez de le localiser sur la carte.",
        SEARCH_HINT:
          'Voici les premiers résultats de {{ searchResultsLimit }} results. Vous ne voyez pas votre bâtiment? Essayez de saisir davantage votre adresse.',

        ERROR_DB: 'Erreur de la base de données',
        ERROR_MESSAGE:
          "Désolé, nous n'avons pas pu rechercher les détails de cette propriété. Réessayez dans une heure, ou veuillez nous contacter <a href='mailto:{{ supportEmail }}'>par courriel</a>",

        // PDF
        PDF_DOWNLOAD_ALL: 'Télécharger toutes les données {{affiliatedWith}}',
        PDF_DOWNLOAD_PROPERTIES:
          'Télécharger les données pour {{ owned }} bâtiments',
        PDF_DOWNLOAD_PROPERTY:
          'Télécharger les données pour {{ owned }} bâtiment',
        PDF_FAILED:
          "Désole! La génération d'un PDF a échoué. Réessayez plus tard.",
